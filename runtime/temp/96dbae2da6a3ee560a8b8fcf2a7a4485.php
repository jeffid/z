<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\rolelist\addrole.html";i:1525603926;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525624138;}*/ ?>
<!DOCTYPE html>
...
<div class="container">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/permissions/roleinsert" method="post">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <div >
                        <ul class="mws-form-list inline">
                            <?php if(is_array($role) || $role instanceof \think\Collection || $role instanceof \think\Paginator): if( count($role)==0 ) : echo "" ;else: foreach($role as $key=>$row): if(empty($rids) || (($rids instanceof \think\Collection || $rids instanceof \think\Paginator ) && $rids->isEmpty())): ?>
    
                            <li><input type="checkbox" value="<?php echo $row['id']; ?>" class="checkbox" name="name[]" > <label><?php echo $row['name']; ?></label></li>
    
                            <?php else: ?>
                            
                            <li><input type="checkbox" value="<?php echo $row['id']; ?>" class="checkbox" name="name[]" <?php if(in_array($row['id'],$rids)): ?>checked<?php endif; ?>> <label><?php echo $row['name']; ?></label></li>
    
                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            
                        </ul>
                        <button type="button" class="kfc">全选</button>
                        <button type="button" class="kfc">全不选</button>
                        <button type="button" class="kfc">反选</button>
                    </div>
                </div>
            </div>
            <div class="mws-button-row">
                ...
                <a href="/permissions/permissions"><input value="返回" class="btn " type="button"></a>
            </div>
        </form>
    </div>
