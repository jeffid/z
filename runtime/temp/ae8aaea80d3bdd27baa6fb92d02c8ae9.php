<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\t.html";i:1524558853;s:56:"D:\APP\wamp\www\XDL\zhipin\application\home\view\t2.html";i:1524560616;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<form action="https://signup.zhipin.com/registe/save.json" method="post"><input type="hidden" name="pk" value="cpc_user_sign_up">
    ...
    <div class="form-row row-code">
        <span class="cell-wrap"><i class="icon-sign-code"></i><input type="text" class="ipt ipt-code" name="captcha" ka="signin-code" maxlength="4" placeholder="验证码" data-url="/captcha/randkey.json"></span><span class="cell-wrap"><img src="./signup_files/saved_resource" class="verifyimg"></span>
    ...
    <div class="text-tip">
        <div class="agreement-tip"><label><input type="checkbox" checked="checked">同意BOSS直聘 <a href="https://www.zhipin.com/register/protocol/introduce" target="_blank">用户协议及隐私政策</a></label></div>
        已有账号 <a href="javascript:;" class="link-signin">直接登录</a></div>
</form>
