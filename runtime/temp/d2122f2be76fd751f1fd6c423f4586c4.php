<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employer\index.html";i:1524818818;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525106077;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="header">
        <div class="inner home-inner">
            ...
            <div class="user-nav">
                ...
                <?php else: if(\think\Session::get('userStatus') == 1): ?>
                ...
                <ul>
                    ...
                    <li class="nav-figure">
                        <a href="#" ka="header-username">
                            <span class="label-text"><?php echo (\think\Session::get('userName')) ? \think\Session::get('userName') :  '请完善资料'; ?></span>
                            <img src="#" alt="">
                        </a>
