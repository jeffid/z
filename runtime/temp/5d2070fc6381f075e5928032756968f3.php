<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\permissions\edit.html";i:1525422145;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminPublic\public.html";i:1525355273;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/permissions/update" method="post">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">用户名</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="username" value="<?php echo $info['username']; ?>" disabled="disabled"></div>
                    <label class="mws-form-label">密码</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="password" value=""></div>
                    <label class="mws-form-label">状态</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="status" value="<?php echo $info['status']; ?>"></div>
                </div>
