<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\job_detail.html";i:1525685174;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525835144;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="main">
                ...
                <div class="job-primary detail-box">
                    ...
                    <div class="info-company">
                        <div class="company-logo">
                            <a ka="job-detail-company" href="/companys/index/cid/<?php echo $info['id']; ?>" title="">
                                <img src="<?php echo isset($info['logos'])?$info['logos']: \think\Session::get('default.logo'); ?>" alt="">
                            </a>
                        </div>
                        <h3 class="name">
                            <a ka="job-detail-company" href="javascript:;" title="<?php echo $info['name']; ?>"><?php echo $info['name']; ?></a>
                        </h3>
        ...
        <div class="smallbanner" style="display: none;">
            <div class="inner home-inner">
                <div class="detail-op">
                    <div class="btns">
                        <?php if(!(empty($deliver_status) || (($deliver_status instanceof \think\Collection || $deliver_status instanceof \think\Paginator ) && $deliver_status->isEmpty()))): ?>
                        <a  href="javascript:;" data-url="" redirect-url="" class="btn btn-startchat">已投递</a>
                        <?php else: ?>
                        <a  href="/personal/deliverAdd?jid=<?php echo $jid; ?>&url=<?php echo \think\Request::instance()->url(); ?>" data-url="" redirect-url="" class="btn btn-startchat">立即投递</a>
                        <?php endif; ?>
                        
                        <div class="op-links">
                            <?php if(!(empty($interest_status) || (($interest_status instanceof \think\Collection || $interest_status instanceof \think\Paginator ) && $interest_status->isEmpty()))): ?>
                            <a href="/personal/interestRemove?jid=<?php echo $jid; ?>&url=<?php echo \think\Request::instance()->url(); ?>"  data-url="" class="link-like2 active">取消感兴趣</a>
                            <?php else: ?>
                            <a href="/personal/interestAdd?jid=<?php echo $jid; ?>&url=<?php echo \think\Request::instance()->url(); ?>"  data-url="" class="link-like2 ">感兴趣</a>
                            <?php endif; ?>
                ...
                <div class="name"><?php echo $row['job']; ?> <span class="badge"><?php echo salary2text($row['salary']); ?></span></div>
            </div>
        </div>
            ...
            <div class="inner home-inner">
                ...
                <div class="job-detail">
                    <div class="detail-figure">
                        <img src="<?php echo isset($hr['avatar'])?$hr['avatar']: \think\Session::get('default.avatar'); ?>" alt="">
                    </div>
                    <div class="detail-op">
                        <div class="btns">
                            <?php if(!(empty($deliver_status) || (($deliver_status instanceof \think\Collection || $deliver_status instanceof \think\Paginator ) && $deliver_status->isEmpty()))): ?>
