<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\category\edit.html";i:1524382994;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminPublic\public.html";i:1525355273;}*/ ?>
<!DOCTYPE html>
...
<body>
  ...
  <div class="mws-panel-body no-padding">
    <form class="mws-form" action="/category/update" method="post">
      <div class="mws-form-inline">
         <div class="mws-form-row">
          <label class="mws-form-label">分类名</label>
          <div class="mws-form-item">
            <input type="text" class="large" name="name" value="<?php echo $cate['name']; ?>"></div>
        </div>
      </div>
