<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\message\detail.html";i:1525632639;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form">
            ...
            <div class="mws-button-row">
                <a href="<?php echo $url; ?>" class="btn btn-danger">返回</a>
            </div>
        </form>
    </div>
</div>
