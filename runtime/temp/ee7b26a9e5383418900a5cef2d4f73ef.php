<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\advertising\edit.html";i:1525830324;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
...
<form class="mws-form" action="/advertising/update" method="post" enctype="multipart/form-data">
    <div class="mws-form-inline">
        ...
        <div class="mws-form-row">
                ...
                <div class="mws-form-row">
                    ...
                    <img src="<?php echo $row['bgs']; ?>" alt="">
                    <div class="mws-form-item">
                    <input type="file" class="large" name="bgs"></div>
                    </div>
                    </div>
                    <div class="mws-button-row">
                    <input type="submit" value="添加" class="btn btn-danger">
                    <a href="/advertising/index"><input type="button" value="返回" class="btn btn-success"></a>
                    </div>
                        </div>
        </form>
