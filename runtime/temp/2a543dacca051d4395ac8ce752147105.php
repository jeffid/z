<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\account.html";i:1524416033;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0064)https://www.zhipin.com/geek/account/management?ka=account_manage -->
...
<head>
    ...
    <meta name="description"
          content="Boss直聘是一款互联网求职招聘找工作软件，让求职者与Boss直接开聊、加快面试、即时反馈，找工作就用Boss直聘。直直为Boss直聘IP，下载APP让直直带你轻松找工作！">
    <link href="./account_files/main.css" type="text/css" rel="stylesheet">
    <script charset="utf-8" src="./account_files/v.js.下载"></script>
    <script src="./account_files/hm.js.下载"></script>
    <script src="./account_files/ka.js.下载"></script>
</head>
<body>
<div id="wrap" class="user-center">
    ...
    <!--uid:37395952,-->
    <!--name:"邓华杰",-->
    <!--face:"https://img.bosszhipin.com/beijin/mcs/useravatar/20180413/45c2fe73c89ffd50cb77fd5188ff50b1cfcd208495d565ef66e7dff9f98764da_s.jpg",-->
    <!--token:"ZGa3W3nHu53KZ0e|0",-->
    <!--clientIP:"23.83.245.186",-->
    <!--ws:{-->
    <!--useSSL:true,-->
        ...
        <div class="inner home-inner">
            ...
            <div class="user-nav">
                ...
                <ul>
                    ...
                    <li class=""><a ka="header-message" href="https://www.zhipin.com/gchat/chat.html">消息<span
                            class="nav-chat-num"></span></a></li>
                    <li class=""><a ka="header-resume" href="https://www.zhipin.com/geek/myresume.html">简历</a></li>
                    <li class="nav-figure"><a href="https://www.zhipin.com/geek/new/index/recommend"
                                              ka="header-username"><span class="label-text">邓华杰</span> <img
                            src="./account_files/45c2fe73c89ffd50cb77fd5188ff50b1cfcd208495d565ef66e7dff9f98764da_s.jpg"
                            alt=""></a>
                        <div class="dropdown" style="display: none;"><a
                                href="https://www.zhipin.com/geek/new/index/recommend" ka="header-personal">个人中心</a><a
                                href="https://www.zhipin.com/geek/account/management" ka="account_manage">账户管理</a><a
                                href="javascript:;" class="link-recruit" ka="header-recruit">我要招聘</a><a
                                href="https://www.zhipin.com/logout/" ka="header-logout">退出</a>
                            <p class="recruit-tip" style="display: none;"><img src="./account_files/recruit-tip.gif"
                                                                               alt=""><span>请在 APP 端“我的 - 设置”中<br>切换为Boss身份，即可进行招聘</span>
                            </p></div>
                    </li>
                </ul>
        ...
        <div class="account-container">
            <div class="set-page">
                <div class="set-nav">
                    ...
                    <ul>
                        <li ka="account_mobile_change" data-tab="phone" data-url="/geek/account/mobile.json"
                            class="cur">手机号码
                        </li>
                        ...
                        <li ka="account_icebreaker" data-tab="sayhello" data-url="/geek/account/greeting.json">设置打招呼语
                        </li>
                    </ul>
                </div>
                            ...
                            <div>
                                ...
                                <div class="operate-area">
                                    <div class="form-row row-select">
                                        <span class="dropdown-select"><i class="icon-select-arrow"></i><em
                                                class="text-select">+86</em><input type="hidden" name="regionCode"
                                                                                   value="+86"></span>
                                        <span class="ipt-wrap"><input type="tel" class="ipt ipt-phone required"
                                                                      placeholder="手机号" maxlength="50" name="account"
                                                                      data-blank="请输入手机号"
                                                                      data-format="请输入正确的手机号"></span>
                        ...
                        <span class="cell-wrap">
                            <input type="text" class="ipt ipt-code ipt-message-code" name="captcha" maxlength="4"
                                   data-blank="请输入短信验证码" data-format="短信验证码错误" placeholder="请输入验证码" >
                                    ...
                                    <div class="form-btn">
                                        <button type="submit" class="btn btn-change-phone" ka="mobile_change_sure">
                                            确认更改手机号
                                        </button>
                                    </div>
                                    <div class="text-tip">
    ...
    <div id="footer">
        <div class="inner home-inner">
            <div class="footer-social">
                <img src="./account_files/footer-logo.png" alt="">
                ...
                <p class="footer-icon">
                    ...
                    <a href="javascript:;" class="icon-weixin" ka="link-weixin"><span>微信公众号</span><img
                            src="./account_files/we_chat_qr.jpg" class="qrcode-weixin"></a>
                    <a href="https://www.zhipin.com/d/v2/?type=ck&amp;pkn=foot&amp;sid=" class="icon-app"
            ...
            <div class="footer-about clear-fix">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <a href="https://www.zhipin.com/activity/cc/anticheatguide.html" ka="link-anticheatguide"
            ...
            <div class="copyright">
                ...
                <p><span>Copyright © 2018 BOSS直聘</span><span>京ICP备14013441号-5</span><span><a
                        href="https://www.zhipin.com/activity/cc/businesslicense.html" ka="link-businesslicense"
                        target="_blank">经营执照</a></span><span><a
                        href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502032801"
                        ka="link-beian" target="_blank">京公网安备11010502032801 <img src="./account_files/icon-beian.png"
                                                                                 alt=""></a></span><span><a
                        href="http://sdwj.zhipin.com/web/index.html" ka="link-sdwj" target="_blank">首都网警</a></span></p>
    ...
    <div id="siderbar" style="display: none;">
        <ul>
            ...
            <li class="siderbar-qrcode" title="BOSS直聘APP">
                <div class="qrcode-layer"><i></i><img src="./account_files/common.json" alt="">下载BOSS直聘APP</div>
            </li>
        </ul>
    </div>
    <!--通用注册登录-->
    <div class="sign-wrap" style="display:none;">
        ...
        <div class="sign-form sign-pwd">
            ...
            <form action="https://www.zhipin.com/login/account.json" method="post">
                <div class="form-row row-select">
                    <span class="dropdown-select"><i class="icon-select-arrow"></i><em
                ...
                <div class="form-row">
                    <input type="password" class="ipt ipt-pwd required" ka="signin-password" placeholder="密码"
                           name="password">
                </div>
                <div class="form-row row-code">
                    <span class="cell-wrap"><i class="icon-sign-code"></i><input type="text" class="ipt ipt-code"
                                                                                 name="captcha" ka="signin-code"
                                                                                 maxlength="4" placeholder="验证码"
                                                                                 data-url="/captcha/randkey.json"></span><span
                        class="cell-wrap"><img class="verifyimg"></span>
        ...
        <div class="sign-form sign-sms">
            ...
            <div class="sign-tab"><span class="link-signin">密码登录</span><span class="link-sms cur">短信登录</span><span
                    class="link-scan">扫码登录</span></div>
            <form action="https://www.zhipin.com/login/phone.json" method="post">
                <div class="form-row row-select">
                    <span class="dropdown-select"><i class="icon-select-arrow"></i><em
                            class="text-select">+86</em><input type="hidden" name="regionCode" value="+86"></span>
                    <span class="ipt-wrap"><i class="icon-sign-phone"></i><input type="tel"
                ...
                <div class="form-row">
                    <span class="ipt-wrap"><i class="icon-sign-sms"></i><input type="text" class="ipt ipt-sms required"
                                                                               ka="signup-sms" placeholder="短信验证码"
                                                                               name="phoneCode" maxlength="4"><input
                            type="hidden" name="smsType" value="1"><button type="button" class="btn btn-sms"
                                                                           data-url="/registe/sendSms.json">发送验证码</button></span>
                </div>
                <div class="form-btn">
                    <button type="submit" class="btn">登录</button>
                </div>
        ...
        <div class="sign-form sign-scan">
            ...
            <div class="qrcode-box">
                ...
                <div class="qrcodeimg-box">
                    ...
                    <img src="https://www.zhipin.com/geek/account/management?ka=account_manage"
                         data-url="https://www.zhipin.com/qrscan/dispatcher?qrId=">
                </div>
        ...
        <div class="sign-form sign-register">
            ...
            <form action="https://www.zhipin.com/registe/save.json" method="post">
                <div class="form-row row-select">
                    <span class="dropdown-select"><i class="icon-select-arrow"></i><em
                            class="text-select">+86</em><input type="hidden" name="regionCode" value="+86"></span>
                    <span class="ipt-wrap"><i class="icon-sign-phone"></i><input type="tel"
                ...
                <div class="form-row">
                    <span class="ipt-wrap"><i class="icon-sign-sms"></i><input type="text" class="ipt ipt-sms required"
                                                                               ka="signup-sms" placeholder="短信验证码"
                                                                               name="phoneCode" maxlength="4"><input
                            type="hidden" name="smsType" value="2"><button type="button" class="btn btn-sms"
                                                                           data-url="/registe/sendSms.json">发送验证码</button></span>
                </div>
                <div class="form-btn">
        ...
        <div class="sign-form sign-welcome">
            ...
            <div class="welcome-box">
                ...
                <img src="./account_files/icon-sign-welcome.png" alt="">
                <div class="form-btn"><a ka="registe-complete" href="https://www.zhipin.com/geek/complete/guide.html"
...
<script src="./account_files/jquery-1.12.2.min.js.下载"></script>
<script src="./account_files/main.js.下载"></script>
<input type="hidden" id="page_key_name" value="cpc_account_manager">
