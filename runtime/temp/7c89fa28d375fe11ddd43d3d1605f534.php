<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\resume\education_add.html";i:1525658826;}*/ ?>
<form data-action="/employee/resumeEducationAddExec" data-form="form-education-add" method="post" class="form-resume">
    <h3 class="title">添加教育经历</h3>
    <div class="form-row">
        <dl>
            <dt>学校名称</dt>
            <dd>
                <input type="text" ka="edu-school" name="school"  class="ipt ipt-autocomplete required"
                       data-url="/autocomplete/school.json" autocomplete="off" placeholder="例如：北京大学" data-range="1,20"
        ...
        <dl>
            <dt>专业名称</dt>
            <dd>
                <input type="text" ka="edu-major" name="major"  class="ipt ipt-autocomplete required"
        ...
        <dl>
            ...
            <dd>
                <span class="dropdown-select">
                    ...
                    <input type="text" name="degreeName"  ka="edu-degree"  class="ipt" placeholder="选择学历" readonly="" required>
                    <input type="hidden" name="degree"  class="required" data-blank="请选择学历">
                </span>
    ...
    <div class="form-row">
        <dl>
            ...
            <dd>
                <span class="dropdown-select">
                    <i class="icon-select-arrow"></i>
                    <input type="text" name="startDateName"  ka="edu-start-date"  class="ipt ipt-range" data-range="start"
                           data-type="y" placeholder="选择年份" readonly="" required>
                    <input type="hidden" name="startDateCode"  class="required" data-blank="请选择时间段">
                </span>
                <div class="dropdown-menu">
                    <ul>
        ...
        <dl>
            ...
            <dd>
                ...
                <span class="dropdown-select">
                    <i class="icon-select-arrow"></i>
                    <input type="text" name="endDateName"  ka="edu-end-date"  class="ipt ipt-range" data-range="end" data-type="y"
                           placeholder="选择年份" readonly="" required>
                    <input type="hidden" name="endDateCode"  class="required" data-blank="请选择时间段">
                </span>
                <div class="dropdown-menu">
                    <ul>
                        <li data-val="-1">至今</li>
