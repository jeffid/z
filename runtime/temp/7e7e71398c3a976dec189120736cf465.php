<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\company\edit.html";i:1524214772;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminPublic\public.html";i:1524535120;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/company/update" method="post" enctype="multipart/form-data">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">简称</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="name" value="<?php echo $info['name']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">全称</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="fullname" value="<?php echo $info['fullname']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">主题背景图</label>
                    <div class="mws-form-item">
                        <input type="file" class="large" name="bg" value="<?php echo $info['bg']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">品牌logo</label>
                    <div class="mws-form-item">
                        <input type="file" class="large" name="logo" value="<?php echo $info['logo']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">融资情况</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="financing" value="<?php echo $info['financing']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">供职人数</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="employees" value="<?php echo $info['employees']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">所在行业</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="industry" value="<?php echo $info['industry']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">简介</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="profile" value="<?php echo $info['profile']; ?>"></div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">官网</label>
                    <div class="mws-form-item">
                        <input type="text" class="large" name="homepage" value="<?php echo $info['homepage']; ?>"></div>
                </div>
        ...
        <div class="mws-button-row">
            <a href="/company/index" class="btn btn-success">返回</a>
        </div>
    </div>
</div>
