<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employer\received_resume.html";i:1525685174;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="set-page">
            <div class="set-nav">
                ...
                <ul>
                    ...
                    <a href="/employer/reindex"><li class="cur">已收简历</li></a>
            ...
            <div class="set-content">
                <div class="set-box sign-form">
                    <!--已发布工作-->
                    <div class="ou" id="div2" style="display: block">
                        ...
                        <div style="width: 900px;border: 0px solid #666;height: 80px;">
                            <span style="width: 40px;float: left;margin-left: -10px">ID:<?php echo $row['id']; ?></span>
                            <span style="width: 100px;float: left">职位:<?php echo $row['j_name']; ?></span>
                            <span style="width: 100px;float: left">姓名:<?php echo $row['username']; ?></span>
                            <span style="width: 200px;float: left">时间:<?php echo date( 'Y-m-d H:i:s',$row['addtime']); ?></span>
                            <span style="width: 160px;float: left">
                                <select name="" id=""  data-btn="select" data-action="/employer/ChangeOfferStatus/id/<?php echo $row['id']; ?>/jid/<?php echo $row['j_id']; ?>">
                                    <option value="0" <?php if($row['status'] == 0): ?>selected <?php endif; ?> >未处理</option>
                                    <option value="1" <?php if($row['status'] == 1): ?>selected <?php endif; ?> >已邀约</option>
                                </select>
                            </span>
                            <span style="width: 60px;float: left">
                                <a href="/employer/review/id/<?php echo $row['uid']; ?>" style="float: left;" class="btn btn-info">查看</a>
                            </span>
                        </div>
