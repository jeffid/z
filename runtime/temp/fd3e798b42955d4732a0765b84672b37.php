<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\permissions\adminadd.html";i:1525632639;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/permissions/admininsert" method="post">
            <div class="mws-form-inline">
                ...
                <div class="mws-form-item">
                <select class="large" name="rid"> <option value="1">普通管理员</option> <option value="2">超级管理员</option> <option value="3">一级管理员</option>  </select>
                </div>
                </div>
                
                
                <div class="mws-button-row">
                    <input type="hidden" class="small" name="id" />
