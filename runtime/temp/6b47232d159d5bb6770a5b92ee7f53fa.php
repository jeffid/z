<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\rolelist\roleadd.html";i:1525632639;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/permissions/roleinsery" method="post">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">权限点</label>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="mname"/>
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">方法</label>
                    <div class="mws-form-item">
                        <input type="text" class="medium" name="aname"/>
                    </div>
                </div>
