<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\permissions\index.html";i:1525830324;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 113px;">管理员</th>
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 113px;">权限</th>
                ...
                <tr class="odd">
                    ...
                    <td class=" "><a href="/permissions/rolelist/id/<?php echo $row['id']; ?>" class="btn btn-success">管理员分配</a> <a href="/permissions/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a> <a href="/adminuser/delete/id/<?php echo $row['id']; ?>" class="btn btn-danger">删除</a></td>
                </tr>
