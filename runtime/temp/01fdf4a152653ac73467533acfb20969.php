<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employee\editpwd.html";i:1524917964;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="account-container">
        <div class="set-page">
            <div class="set-nav">
                ...
                <ul>
                    <a href="/employee/phoneEdit"><li>手机号码</li></a>
                    <a href="/employee/pwdEdit"><li class="cur">密码管理</li></a>
                </ul>
            </div>
            
            <div class="set-content">
                <form data-action="/employee/PwdAddExec" class="form-editpwd" data-form="form-employee-pwd-add">
                    <div class="bind-phone">
                        <span class="txt-msg">当前登录的账号</span>
                        <div class="operate-area"><span class="phone-num"><?php echo $p; ?></span></div>
                    </div>
                    <!-- 初始设置密码的时候 -->
                    <div>
                        <span class="txt-msg" style="margin-top: 20px">设置登录密码</span>
                        <div class="operate-area">
                            <div class="form-row row-code">
                                <span class="cell-wrap" style="margin-top: 20px">
                                    <input type="password" class="ipt ipt-code ipt-pwd-orginal" placeholder="请输入密码" data-format="请设置6-20位数字与字母组合密码" data-blank="请输入密码" name="password" value="" minlength="6" maxlength="18" required>
                                </span>
                            </div>
                            <div class="form-row row-code" style="margin-top: 20px">
                                <span class="cell-wrap" >
                                    <input type="password" class="ipt ipt-code ipt-pwd-orginal-confirm" data-blank="请重复输入密码" data-format="两次输入密码不一致" placeholder="请确认密码" name="repassword" value="" minlength="6" maxlength="18" required>
                                </span>
                            </div>
                            <div class="form-btn" style="margin-top: 20px">
                                <button type="submit" class="btn btn-origin-pwd" ka="pwd_add_sure">设置密码</button>
                            </div>
                        </div>
                    </div>
