<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\Admin\index.html";i:1525685174;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_2">
    ...
    <div class="mws-panel-body no-padding">
        <ul class="mws-summary ">
            <li>
                <span class="key"> 管理员账号</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $username; ?></span>
                                </span>
            </li>
            <li>
                <span class="key"> 所属权限组</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $group; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">当前登录IP</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $cur_ip; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">上次登录IP</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $last_ip; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">上次登录时间</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo date('Y-m-d H:i:s',$last_time); ?></span>
                                </span>
            </li>
            <li>
                <span class="key">第几次登录</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $count; ?></span>
                                </span>
            </li>
        </ul>
    </div>
...
<div class="mws-panel grid_2">
    ...
    <div class="mws-panel-body no-padding">
        <ul class="mws-summary ">
            <li>
                <span class="key"> 主机名</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $server_name; ?></span>
                                </span>
            </li>
            <li>
                <span class="key"> 服务器标识字符串</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $server_software; ?></span>
                                </span>
            </li>
...
<div class="mws-panel grid_2">
    ...
    <div class="mws-panel-body no-padding">
        <ul class="mws-summary ">
            <li>
                <span class="key"> 总用户数</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $total_user; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">今日新用户数</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $new_user; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">总招聘数</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $total_job; ?></span>
                                </span>
            </li>
            <li>
                <span class="key">今日发布招聘数</span>
                <span class="val">
                                    <span class="text-nowrap"><?php echo $new_job; ?></span>
                                </span>
            </li>
...
<div class="mws-panel grid_1">
    ...
    <div class="mws-panel-body no-padding">
        <ul class="mws-summary ">
            <?php if(is_array(\think\Session::get('admin.node')) || \think\Session::get('admin.node') instanceof \think\Collection || \think\Session::get('admin.node') instanceof \think\Paginator): $i = 0; $__LIST__ = \think\Session::get('admin.node');if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
            <li>
                <span class="val"> <?php echo $item['name']; ?></span>
            </li>
