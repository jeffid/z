<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\articles\index.html";i:1524308367;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminPublic\public.html";i:1525505549;}*/ ?>
<!DOCTYPE html>
            ...
            <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-functions">
                    ...
                    <ul>
                        ...
                        <li><a href="/adminlogin/logout">
                            <?php if(\think\Session::get('rid') == \think\Session::get('r_id')): ?> <?php echo \think\Session::get('name'); endif; ?>
                        </a></li>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-th-list"></i>管理模块</a>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/adminuser/index">会员列表</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/category/add">分类添加</a></li>
                            <li><a href="/category/index">分类列表</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            ...
                            <li><a href="/permissions/permissionsadd">权限添加</a></li>
                            <li><a href="/permissions/permissions">权限列表</a></li>
                    ...
                    <li>
                        <a href="#"><i class="icon-lastfm"></i> 品牌模块</a>
                        <ul class="closed">
                            <li><a href="/company/add">品牌添加</a></li>
                            <li><a href="/company/index">品牌列表</a></li>
                        </ul>
                    </li>
    
                    <li>
                        <a href="#"><i class="icon-edit"></i>公告模块</a>
                        <ul class="closed">
                            <li><a href="/articles/add">公告添加</a></li>
                            <li><a href="/articles/index">公告列表</a></li>
                        </ul>
                    </li>
...
<div class="mws-panel grid_8">
 <div class="mws-panel-header">
  <script type="text/javascript" src="/static/admins/jquery-1.8.3.min.js"></script>
  <span>
      <i class="icon-table"></i>公告列表</span>
 </div>
 <div class="mws-panel-body no-padding">
  <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
   <div id="uid">
    <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
     ...
     <tr role="row">
      ...
      <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 137px;">标题</th>
      <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 124px;">内容</th>
      <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 85px;">图片</th>
     ...
     <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): if( count($user)==0 ) : echo "" ;else: foreach($user as $key=>$rows): ?>
     <tr class="odd">
      <td class="  sorting_1"><?php echo $rows['id']; ?></td>
      <td class=" "><?php echo $rows['title']; ?></td>
      <td class=" "><?php echo $rows['descr']; ?></td>
      <td class=" "><img src="<?php echo $rows['pic']; ?>"></td>
      <td class=" "><a href="/articles/delete/id/<?php echo $rows['id']; ?>" class="btn btn-success">删除</a><a href="/articles/edit/id/<?php echo $rows['id']; ?>" class="btn btn-info">修改</a></td>
     </tr>
   ...
   <div class="dataTables_paginate paging_full_numbers" id="pages">
    <?php echo $user->appends($data)->render(); ?>
   </div>
  </div>
 </div>
</div>
