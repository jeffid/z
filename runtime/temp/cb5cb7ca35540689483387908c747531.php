<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\carousel\index.html";i:1525830323;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span style="float: left"><i class="icon-table"></i> 轮播图列表</span>
    </div>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                ...
                <tr class="odd">
                    ...
                    <td class="" style="text-align: center"><a href="/carousel/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a> <a href="/carousel/delete/id/<?php echo $row['id']; ?>" class="btn">从轮播队列移除</a>
                    </td>
                </tr>
