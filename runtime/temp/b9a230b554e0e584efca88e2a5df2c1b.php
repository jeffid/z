<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\Category\add.html";i:1524382294;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525631924;}*/ ?>
<!DOCTYPE html>
...
<body>
  ...
  <div class="mws-panel-body no-padding">
    <form class="mws-form" action="/category/insert" method="post">
        ...
        <div class="mws-form-row"> 
         ...
         <div class="mws-form-item"> 
          <select class="large" name="pid">
              <option value="0">--请选择(不选择默认顶级类别)--</option>
