<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employer\job_list.html";i:1525194252;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="set-box sign-form">
                    ...
                    <div class="ou" id="div2" style="display: block">
                        ...
                        <div style="width: 900px;border: 0px solid #666;height: 80px">
                            <span style="width: 60px;float: left">ID:<?php echo $row['id']; ?></span>
                            <span style="width: 160px;float: left">职位:<?php echo $row['job']; ?></span>
                            <span style="width: 200px;float: left">时间:<?php echo date( 'Y-m-d H:i:s',$row['timestamp']); ?></span>
                            <span style="width: 160px;float: left">状态:
                                <a href="/employer/changestatus/id/<?php echo $row['id']; ?>" class="btn" data-btn="changestatus"
                                   data-status="<?php echo $row['status']; ?>"><?php if($row['status'] == 1): ?>可用 <?php else: ?> 禁用<?php endif; ?></a></span>
                            <span style="width: 60px;float: left">
                                <a href="/employer/edit/id/<?php echo $row['id']; ?>" style="float: left;"
