<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\permissions\rolelist.html";i:1524044781;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
...
<div class="container">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/permissions/saverole" method="post">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">角色信息</label>
                    <div >
                        <h4>当前用户:<?php echo $info['username']; ?>的角色信息</h4>
                        <ul class="mws-form-list inline">
                            ...
                            <li><input type="radio" value="<?php echo $row['id']; ?>" name="rid[]" <?php if(in_array($row['id'],$rids)): ?>checked<?php endif; ?>> <label><?php echo $row['name']; ?></label></li>
