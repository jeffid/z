<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\category\seed.html";i:1524382785;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminPublic\public.html";i:1525355273;}*/ ?>
<!DOCTYPE html>
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/adminuser/add">会员添加</a></li>
                    ...
                    <li>
                        <a href="#"><i class="icon-gift"></i>活动模块</a>
                        <ul class="closed">
                            <li><a href="">活动添加</a></li>
                            <li><a href="">活动列表</a></li>
                        </ul>
...
<div class="mws-panel grid_8">
  <div class="mws-panel-header">
    <span style="float: left"><i class="icon-table"></i>分类列表</span>
    <span style="float: left;margin-left: 20px;margin-top: -5px;" class="btn btn-info"><a href="/category/back/id/<?php echo $id; ?>" style="text-decoration: none;color:#fff">   返回上一级</a></span>
  </div>
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 137px;">分类名</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 124px;">pid</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 85px;">path</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
            ...
            <td class=" "><a href="/category/seed/id/<?php echo $row['id']; ?>" style="color: #333;display: block;width: 100%;height: 100%;text-decoration: none"><?php echo $row['name']; ?></a></td>
            <td class=" "><?php echo $row['pid']; ?></td>
            <td class=" "><?php echo $row['path']; ?></td>
            <td class=" "><a href="/category/delete/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a><a href="/category/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a></td>
          </tr>
