<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\personal\interest.html";i:1525664940;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525632639;s:68:"D:\APP\wamp\www\XDL\zhipin\application\home\view\personal\sider.html";i:1525632639;s:73:"D:\APP\wamp\www\XDL\zhipin\application\home\view\personal\pop_resume.html";i:1525018033;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="user-sider-left">
            <div class="chat-history">
                <div class="job-tab">
                    ...
                    <a href="/personal/deliver" ka="personal_top_sawme_0" >已投递</a>
                    <a href="/personal/interview" ka="personal_top_interview">面试</a>
                    <a href="/personal/interest" ka="personal_top_interest" class="cur">感兴趣</a>
                </div>
                <ul>
                    <?php if(empty($data[0]) || (($data[0] instanceof \think\Collection || $data[0] instanceof \think\Paginator ) && $data[0]->isEmpty())): ?>
                    <!--无职位-->
                    <div class="data-tips">
                        <div class="data-blank">
                            <i class="tip-nodata"></i><b>暂时未有添加到感兴趣，建议尝试多与Boss沟通</b>
                            <p><a href="https://www.zhipin.com/geek/new/index/recommend/"
                                  ka="personal_submitted_recommend" class="btn">查看推荐职位</a></p>
                        </div>
                    </div>
                    
                   <?php else: if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <!--感兴趣-->
                    <li class="item-boss">
                        ...
                        <div class="item-content">
                            <div class="info-header">
                                ...
                                <a  href="/personal/interestRemove/list/1/jid/<?php echo $item['j_id']; ?>" class="btn" data-url="">取消感兴趣</a>
                                </div>
