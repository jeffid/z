<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\resume\history_edit.html";i:1525658743;}*/ ?>
<form data-action="/employee/resumeHistoryEditExec"  method="post" class="form-resume" data-form="form-history-edit">
    <h3 class="title">编辑工作经历</h3>
    <div class="form-row">
        <dl>
            <dt>公司名称</dt>
            <dd>
                <input type="text" ka="work-company" name="company" value="<?php echo $hi_company; ?>" class="ipt required"
        ...
        <dl>
            ...
            <dd>
                <span class="dropdown-select">
                    ...
                    <input type="text" ka="work-position" name="positionType" value="<?php echo $hi_type; ?>" class="ipt" placeholder="选择职位类型" readonly="">
    ...
    <div class="form-row">
        <dl>
            <dt>职位名称</dt>
            <dd>
                <input type="text" ka="work-position-name" name="positionName" value="<?php echo $hi_position; ?>" class="ipt required"
        ...
        <dl>
            ...
            <dd>
                <span class="">
                    <input type="text" ka="work-industry" value="<?php echo $hi_industry; ?>" name="industryCategory" class="ipt ipt-industry"
    ...
    <div class="form-row">
        <dl>
            ...
            <dd>
                <span class="dropdown-select">
                    <i class="icon-select-arrow"></i>
                    <input type="text" value="<?php echo $hi_startdate; ?>" class="ipt ipt-range" data-range="start" data-type="y"
                           placeholder="选择年份" readonly="" name="startDateName">
                    <input type="hidden" name="startDate" value="<?php echo $hi_startdate; ?>" class="required" data-blank="请选择时间段">
                </span>
                <div class="dropdown-menu">
                    <ul>
        ...
        <dl>
            ...
            <dd>
                ...
                <span class="dropdown-select">
                    <i class="icon-select-arrow"></i>
                    <input type="text" value="<?php echo $hi_enddate; ?>" class="ipt ipt-range" data-range="end" data-type="y" placeholder="选择年份"
                           readonly="" name="endDateName">
                    <input type="hidden" name="endDate" value="<?php echo $hi_enddate; ?>" class="required" data-blank="请选择时间段">
                </span>
                <div class="dropdown-menu">
                    <ul>
                        <li data-val="-1">至今</li>
    ...
    <div class="form-row">
        <dl>
            <dt>所属部门</dt>
            <dd>
                <input type="text" ka="work-department" name="department" value="<?php echo $hi_department; ?>" class="ipt" placeholder="选填"
        ...
        <dl>
            ...
            <dd>
                <textarea name="responsibility" ka="work-responsibility"
                          ...
                          data-format="请输入 1600 字以内的工作内容" maxlength="1600" value="<?php echo $hi_work; ?>"><?php echo $hi_work; ?></textarea>
        ...
        <dl>
            ...
            <dd>
                <textarea name="workPerformance" ka="work-performance"
                          ...
                          maxlength="300" value="<?php echo $hi_results; ?>"><?php echo $hi_results; ?></textarea>
