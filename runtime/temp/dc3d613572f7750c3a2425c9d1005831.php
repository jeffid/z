<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\user\index.html";i:1525830763;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
   ...
   <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
    <form action="/adminuser/index" method="get">
     <div class="dataTables_filter" id="DataTables_Table_1_filter">
      <label>Search:
       <input type="text" aria-controls="DataTables_Table_1" name="keywords" value="<?php echo $k; ?>"></label>
    ...
    <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
     <thead>
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 113px;">手机号</th>
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 113px;">注册时间</th>
      ...
      <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): if( count($user)==0 ) : echo "" ;else: foreach($user as $key=>$row): ?>
       <tr class="odd"> 
        ...
        <td class=" ">
         <?php if($row['status'] == 0): ?> 普通用户
         <?php elseif($row['status']==1): ?>HR
         <?php else: ?> 禁用
         <?php endif; ?>
        </td>
        <td class=" "><a href="/resume/index/id/<?php echo $row['id']; ?>" class="btn btn-success">查看简历</a> <a href="/adminuser/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a> <a href="/adminuser/delete/id/<?php echo $row['id']; ?>" class="btn btn-danger">删除</a></td>
       </tr>
