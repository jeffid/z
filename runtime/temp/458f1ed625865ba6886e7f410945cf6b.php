<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employee\editphone.html";i:1524917964;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="account-container">
        <div class="set-page">
            <div class="set-nav">
                ...
                <ul>
                    <a href="/employee/phoneEdit"><li class="cur">手机号码</li></a>
                    <a href="/employee/pwdEdit"><li>密码管理</li></a>
                </ul>
            </div>
            ...
            <div class="set-content">
                <div class="set-box sign-form">
                    <div class="set-box sign-form" style="display: block">
                        <form data-action="/employee/PhoneEditExec" class="form-phone" data-form="form-employee-phone-edit">
                            ...
                            <div>
                                ...
                                <div class="operate-area">
                                    ...
                                    <span class="dropdown-select">
                                        ...
                                        <span class="ipt-wrap">
                                        <input type="tel" class="ipt ipt-phone required" placeholder="手机号"  minlength="5" maxlength="11" required name="phone" data-blank="请输入手机号" data-format="请输入正确的手机号">
                                    </span>
                        ...
                        <span class="cell-wrap">
                            <input type="text" data-blank="请输入图片验证码" data-format="图片验证码错误" class="ipt ipt-code ipt-image-code" name="captcha" maxlength="4" required placeholder="请输入图片验证码" data-url="">
                        </span>
                                        <span class="cell-wrap">
                            <img class="captcha" src="<?php echo captcha_src(); ?>" alt="" onclick='this.src="<?php echo captcha_src(); ?>?rand="+Math.random()' class="verifyimg">
                        </span>
                                        <input type="hidden" name="randomKey" class="randomkey" value="4mXnoBrJULFN6z5gjI378flD4JIe1x6c">
                                    </div>
                                    <div class="form-row row-code">
                        <span class="cell-wrap">
                            <input type="text" class="ipt ipt-code ipt-message-code" name="phoneCode" maxlength="4"  required data-blank="请输入短信验证码" data-format="短信验证码错误" placeholder="请输入验证码">
                        </span>
