<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\APP\wamp\www\XDL\zhipin\public/../application/admin\view\message\index.html";i:1525632639;s:73:"D:\APP\wamp\www\XDL\zhipin\application\admin\view\adminpublic\public.html";i:1525632639;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        ...
        <span>
      <i class="icon-table"></i>站内信列表
        <a href="/message/add" class="btn btn-primary btn-small">继续添加</a>
        </span>
    </div>
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            ...
                            aria-label="Rendering engine: activate to sort column descending" style="width: 100px;">ID
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending"
                            style="width: 137px;">发布者ID
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending"
                            style="width: 137px;">标题
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending"
                            style="width: 124px;">消息组
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                            rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending"
                            style="width: 85px;">发送时间
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                 ...
                 `expiretime` int(10) unsigne
                    -->
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                    <?php if(is_array($msg) || $msg instanceof \think\Collection || $msg instanceof \think\Paginator): if( count($msg)==0 ) : echo "" ;else: foreach($msg as $key=>$item): ?>
                    <tr class="odd">
                        <td class=""><?php echo $item['id']; ?></td>
                        <td class=""><?php echo $item['sender_id']; ?></td>
                        <td class=" "><?php echo $item['title']; ?></td>
                        <td class=" "><?php echo scope2text($item['scope']); ?></td>
                        <td class=" "><?php echo date('Y年m月d日 H时i分s秒',$item['addtime']); ?></td>
                        <td class=" ">
                            <a href="/message/detail?id=<?php echo $item['id']; ?>&url=<?php echo \think\Request::instance()->url(); ?>" class="btn btn-success">查看详情</a>
                            <a  href="/message/edit?id=<?php echo $item['id']; ?>&url=<?php echo \think\Request::instance()->url(); ?>" class="btn btn-info">修改</a>
                        </td>
                    </tr>
