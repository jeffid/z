<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\guide.html";i:1524657602;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0047)https://www.zhipin.com/geek/complete/guide.html -->
<html class="standard"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="./js/hm.js"></script><script src="./js/ka.js">
...
<div id="wrap">
    <div id="main">
        <div class="header">
            <a class="logo" href="https://www.zhipin.com/" ka="header-logo"><img src="./img/login-logo.png"></a>
            <div>
                <h3>找工作要跟</h3>
                <h3>老板谈</h3>
            </div>
            ...
            <div class="container-box">
                ...
                <div class="base-info info-box">
                    <div class="description">
                        <div class="top"><i class="icon icon-description"></i></div>
                        <div class="center">在BOSS直聘每一个完善信息的求职者，平均每天会遇到<span>5</span>个对你感兴趣的Boss</div>
                        <div class="bottom">zhipin.com</div>
                    </div>
                    <div class="form-box">
                        <h4>您的基本信息</h4>
                        <form action="https://www.zhipin.com/geek/user/save.json" method="post">
                            <input type="hidden" name="edit" value="complete">
                            <input type="hidden" name="weixin" value="">
                            <!--<div>-->
                                <!--<dd class="avatar_box">-->
                                    <!--<div class="avatar" upload-base64-url="/geek/upload/avatar64.json" ka="upload-avatar" upload="uploadURL=/user/upload/avatar/?c=uploadPortrit&amp;jsCallback=uploadOk" action="/boss/update/headImg.json" method="post">-->
                                        <!--<img src="./img/avatar-default.png">-->
                                        <!--<div class="sel-avatar" ka="boss-profile-avatar"><input type="file" name="file" data-blank="请上传头像！"></div>-->
                                        <!--<input name="large" value="" class="required" data-blank="请设置头像" type="hidden">-->
                                        <!--<input name="tiny" value="" class="required" data-blank="请设置头像" type="hidden">-->
                                    <!--</div>-->
                                <!--</dd>-->
                            <!--</div>-->
                            <div class="form-row">
                                <dd>
                                    <input type="text" value="" ka="name" class="ipt ipt-short required" placeholder="输入您的姓名" data-range="1,12" data-blank="请输入姓名" data-format="请填写真实姓名" maxlength="24" name="name">
                                </dd>
                            </div>
                            <div class="form-row">
                                <dd>
                                    <div class="radio-list">
                                        <label class="radio-square  " ka="gender-1" data-val="1">男</label>
                                        <label class="radio-square " ka="gender-0" data-val="0">女</label>
                                        <input type="hidden" name="gender" class="required" data-blank="请选择性别" value="">
                                    </div>
                                </dd>
                            </div>
                            <div class="form-row row-birthday">
                                <dd>
                                    <span class="dropdown-select"><i class="icon-select-arrow"></i>
                                        
                                            
                                            
                                                <input type="text" ka="geek-birthday" class="ipt ipt-datetimepicker required" data-type="y-m" data-format="yyyy-mm" placeholder="选择出生年月" readonly="" autocomplete="off" data-blank="请选择出生年月" name="birthday" value="">
                            ...
                            <div class="form-row">
                                <dd>
                                    <span class="dropdown-select"><i class="icon-select-arrow"></i>
                                        <input type="text" ka="geek-birthday" class="ipt ipt-workyear required" placeholder="参加工作时间" readonly="true" autocomplete="off" data-min="1990" data-max="2018" data-blank="请选择参加工作时间" data-fill="startWorkYearCode" name="startWorkYear" value="">
                                        <input type="hidden" name="startWorkYearCode" value="">
                                    </span>
                                </dd>
                            </div>
                            <div class="form-row">
                                <dd>
                                    <span class="dropdown-select"><i class="icon-select-arrow"></i>
                                        <input type="text" class="ipt" ka="applystatus" value="" placeholder="当前求职状态" readonly="">
                                        <input type="hidden" name="applyStatus" value="" class="required" data-blank="请选择求职状态">
                                    </span>
                                    <div class="dropdown-menu">
                                        <ul>
                                            <li ka="applystatus-0" data-val="0">离职-随时到岗</li>
                                            <li ka="applystatus-1" data-val="1">在职-暂不考虑</li>
                                            <li ka="applystatus-2" data-val="2">在职-考虑机会</li>
                                            <li ka="applystatus-3" data-val="3">在职-月内到岗</li>
                                        </ul>
                                    </div>
                                </dd>
                            </div>
                            <div class="btn-footer">
                                <button type="submit" ka="userinfo-next" class="btn">下一步</button>
                                <div class="guide-link-app">
                                    若您需要招聘，<a target="_blank" href="https://www.zhipin.com/app.html">请到APP中登录操作</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <!-- 工作经历 -->
                <div class="experience-info info-box hide">
                    <div class="description">
                        <div class="top"><i class="icon icon-experience"></i></div>
                        <div class="center">描述您最近的工作经历，我们会帮您找到适合的Boss</div>
                        <div class="bottom">zhipin.com</div>
                    </div>
                    <div class="form-box">
                        <h4>最近一份工作经历</h4>
                        <form action="https://www.zhipin.com/geek/saveWorkExperience.json" class="form-work">
                            <input type="hidden" name="edit" value="complete">
                            <input type="hidden" name="id" value="">
                            <input type="hidden" name="industryCode" value="">
                            <input type="hidden" name="industryCategory" value="">
                            <input type="hidden" name="department" value="">
                            <input type="hidden" name="positionName" value="">
                            <input type="hidden" name="workPerformance" value="">
                            <input type="hidden" name="isPublic" checked="checked" value="1">
                            <div class="form-row">
                                <dd>
                                    <input type="text" ka="work-company" name="company" value="" class="ipt required" placeholder="公司全称" data-range="1,46" data-blank="请输入公司名称" data-format="请输入不超过 46 个中文字符" maxlength="92">
                                </dd>
                            </div>
                            <div class="form-row">
                                <dd>
                                    <span class="dropdown-select">
                                        ...
                                        <input type="text" ka="work-position" value="" class="ipt" placeholder="您的职位" readonly="">
                                        <input type="hidden" value="" level2="" name="position" class="required" data-blank="请选择职位类型">
                                    </span>
                                    <div class="dropdown-menu">
                                        <script>
                            ...
                            <div class="form-row">
                                <dd>
                                    <span class="dropdown-select"><i class="icon-select-arrow"></i><input type="text" class="ipt" value="" placeholder="选择技能标签" readonly=""><input type="hidden" name="workEmphasis" class="required" data-blank="必填" data-format="最多可选 3 个技能标签"></span>
                                    <div class="dropdown-menu">
                                        <div class="select-industry select-tags">
                                            <div class="industry-title tags-title">
                                                <div class="btns"><button class="btn btn-back" type="button">取消</button><button class="btn" type="button">确定</button></div>
                                                    <input type="text" class="ipt" placeholder="请填写关键词" style="min-width: 160px;"><button class="btn btn-addtag">添加</button>
                                                    <p class="gray">最多可选 3 个技能标签</p>
                                                </div>
                                                <div class="industry-cells tags-cells">
                            ...
                            <div class="form-row">
                                <dl>
                                    <dd>
                                        <span class="dropdown-select">
                                            <i class="icon-select-arrow"></i>
                                            <input type="text" ka="work-start-date" name="startDate" value="" class="ipt ipt-datetimepicker date-range required" data-type="y-m" data-minyear="1989" data-format="yyyy-mm" placeholder="入职时间" readonly="" autocomplete="off" data-blank="请选择入职时间">
                                ...
                                <dl>
                                    <dd>
                                        <span class="dropdown-select">
                                            ...
                                            <input type="text" ka="work-end-date" name="endDate" data-today="true" value="" class="ipt ipt-datetimepicker date-range " data-type="y-m" data-format="yyyy-mm" placeholder="离职时间" readonly="" autocomplete="off" data-blank="请选择离职时间">
                            ...
                            <div class="form-row">
                                <dd>
                                    <div class="text-con">
                                        <textarea name="responsibility" ka="work-responsibility" placeholder="您的工作内容例如：1.负责新员工入职培训；2.分析制定员工每月销售业绩等... " class="ipt required" data-range="1,300" data-blank="请填写工作内容" data-format="请输入 300 字以内的工作内容" maxlength="600"></textarea>
                                        <span class="count-num"><em>0</em>/300</span>
                                    </div>
                                </dd>
                            </div>
                            <div class="btn-footer">
                                <a href="javascript:;" ka="work-previous" class="prev">上一步</a>
                                <button type="submit" ka="work-next" class="btn">下一步</button>
                            </div>
                        </form>
                    </div>
                </div>
                <!-- 学历 -->
                <div class="education-info info-box hide">
                    <div class="description">
                        <div class="top"><i class="icon icon-education"></i></div>
                        <div class="center">完善学历信息<br>您的简历会被送到更多Boss的眼前</div>
                        <div class="bottom">zhipin.com</div>
                    </div>
                    <div class="form-box">
                        <h4>您的学历信息</h4>
                        <form action="https://www.zhipin.com/geek/saveEduExperience.json">
                            <input type="hidden" name="id" value="">
                            <input type="hidden" name="edit" value="complete">
                            <input type="hidden" name="eduDescription" value="">
                            <div class="form-row">
                                <dd>
                                    <input type="text" ka="edu-school" name="school" value="" class="ipt ipt-autocomplete required" data-url="/autocomplete/school.json" autocomplete="off" placeholder="例如：北京大学" data-range="1,20" data-blank="请输入您的学校名称" data-format="请输入 20 字以内的学校名称" maxlength="40">
                                    <div class="suggest-complete"></div>
                                </dd>
                            </div>
                            <div class="form-row">
                                <dd>
                                    <input type="text" ka="edu-major" name="major" value="" class="ipt ipt-autocomplete required" data-url="/autocomplete/major.json" autocomplete="off" placeholder="例如：计算机科学与技术" data-range="1,20" data-blank="请输入您的专业名称" data-format="请输入 20 字以内的专业名称" maxlength="40">
                                    <div class="suggest-complete"></div>
                                </dd>
                            </div>
                            <div class="form-row">
                                <dd>
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                            <li data-val="207" ka="degree-207">中专及以下</li>
                                            <li data-val="206" ka="degree-206">高中</li>
                                            <li data-val="202" ka="degree-202">大专</li>
                                            <li data-val="203" ka="degree-203">本科</li>
                                            <li data-val="204" ka="degree-204">硕士</li>
                                            <li data-val="205" ka="degree-205">博士</li>
                                        </ul>
                                    </div>
                                </dd>
                            </div>
                                ...
                                <dl>
                                    <dd>
                                        <span class="dropdown-select">
                                            ...
                                            <input type="text" ka="edu-start-date" value="" class="ipt ipt-short ipt-range" data-range="start" data-type="y" placeholder="入学年月" readonly="">
                                            <input type="hidden" name="startDateCode" value="" class="required" data-blank="请选择入学年月">
                                        </span>
                                        <div class="dropdown-menu">
                                            <ul>
                                                
                                                    <li data-val="2018" ka="edu-start-2018">2018</li>
                                                
                                                    <li data-val="2017" ka="edu-start-2017">2017</li>
                                                
                                                    <li data-val="2016" ka="edu-start-2016">2016</li>
                                                
                                                    <li data-val="2015" ka="edu-start-2015">2015</li>
                                                
                                                    <li data-val="2014" ka="edu-start-2014">2014</li>
                                                
                                                    <li data-val="2013" ka="edu-start-2013">2013</li>
                                                
                                                    <li data-val="2012" ka="edu-start-2012">2012</li>
                                                
                                                    <li data-val="2011" ka="edu-start-2011">2011</li>
                                                
                                                    <li data-val="2010" ka="edu-start-2010">2010</li>
                                                
                                                    <li data-val="2009" ka="edu-start-2009">2009</li>
                                                
                                                    <li data-val="2008" ka="edu-start-2008">2008</li>
                                                
                                                    <li data-val="2007" ka="edu-start-2007">2007</li>
                                                
                                                    <li data-val="2006" ka="edu-start-2006">2006</li>
                                                
                                                    <li data-val="2005" ka="edu-start-2005">2005</li>
                                                
                                                    <li data-val="2004" ka="edu-start-2004">2004</li>
                                                
                                                    <li data-val="2003" ka="edu-start-2003">2003</li>
                                                
                                                    <li data-val="2002" ka="edu-start-2002">2002</li>
                                                
                                                    <li data-val="2001" ka="edu-start-2001">2001</li>
                                                
                                                    <li data-val="2000" ka="edu-start-2000">2000</li>
                                                
                                                    <li data-val="1999" ka="edu-start-1999">1999</li>
                                                
                                                    <li data-val="1998" ka="edu-start-1998">1998</li>
                                                
                                                    <li data-val="1997" ka="edu-start-1997">1997</li>
                                                
                                                    <li data-val="1996" ka="edu-start-1996">1996</li>
                                                
                                                    <li data-val="1995" ka="edu-start-1995">1995</li>
                                                
                                                    <li data-val="1994" ka="edu-start-1994">1994</li>
                                                
                                                    <li data-val="1993" ka="edu-start-1993">1993</li>
                                                
                                                    <li data-val="1992" ka="edu-start-1992">1992</li>
                                                
                                                    <li data-val="1991" ka="edu-start-1991">1991</li>
                                                
                                                    <li data-val="1990" ka="edu-start-1990">1990</li>
                                                
                                                <li data-val="1989" ka="edu-start-1989">1990年以前</li>
                                            </ul>
                                        </div>
                                    </dd>
                                </dl>
                                <dl>
                                    <dd>
                                        <span class="dropdown-select">
                                            ...
                                            <input type="text" ka="edu-end-date" value="" class="ipt ipt-range ipt-short" data-range="end" data-type="y" placeholder="毕业年月" readonly="">
                                            <input type="hidden" name="endDateCode" value="" class="required" data-blank="请选择毕业年月">
                                        </span>
                                        <div class="dropdown-menu">
                                            <ul><li data-val="-1">至今</li><li data-val="2018" ka="edu-start-2018">2018</li><li data-val="2017" ka="edu-start-2017">2017</li><li data-val="2016" ka="edu-start-2016">2016</li><li data-val="2015" ka="edu-start-2015">2015</li><li data-val="2014" ka="edu-start-2014">2014</li><li data-val="2013" ka="edu-start-2013">2013</li><li data-val="2012" ka="edu-start-2012">2012</li><li data-val="2011" ka="edu-start-2011">2011</li><li data-val="2010" ka="edu-start-2010">2010</li><li data-val="2009" ka="edu-start-2009">2009</li><li data-val="2008" ka="edu-start-2008">2008</li><li data-val="2007" ka="edu-start-2007">2007</li><li data-val="2006" ka="edu-start-2006">2006</li><li data-val="2005" ka="edu-start-2005">2005</li><li data-val="2004" ka="edu-start-2004">2004</li><li data-val="2003" ka="edu-start-2003">2003</li><li data-val="2002" ka="edu-start-2002">2002</li><li data-val="2001" ka="edu-start-2001">2001</li><li data-val="2000" ka="edu-start-2000">2000</li><li data-val="1999" ka="edu-start-1999">1999</li><li data-val="1998" ka="edu-start-1998">1998</li><li data-val="1997" ka="edu-start-1997">1997</li><li data-val="1996" ka="edu-start-1996">1996</li><li data-val="1995" ka="edu-start-1995">1995</li><li data-val="1994" ka="edu-start-1994">1994</li><li data-val="1993" ka="edu-start-1993">1993</li><li data-val="1992" ka="edu-start-1992">1992</li><li data-val="1991" ka="edu-start-1991">1991</li><li data-val="1990" ka="edu-start-1990">1990</li></ul>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                            ...
                            <div class="btn-footer">
                                <a href="javascript:;" ka="edu-previous" class="prev">上一步</a>
                                <button type="submit" ka="edu-next" class="btn">下一步</button>
                            </div>
                        </form>
                    </div>
                </div>
                <!-- 期望工作 -->
                <div class="position-info info-box hide">
                    <div class="description">
                        <div class="top"><i class="icon icon-position"></i></div>
                        <div class="center">您的经历符合<span>3374</span>个Boss的要求<br>现在，提出你的条件</div>
                        <div class="bottom">zhipin.com</div>
                    </div>
                    <div class="form-box">
                        <h4>您期待怎样的工作？</h4>
                        <form action="https://www.zhipin.com/geek/saveGeekExpectPosition.json">
                            <input name="expectedJobId" type="hidden" value="">
                            <input name="edit" value="complete" type="hidden">
                            <div class="form-row">
                                <dd>
                                    <span class="dropdown-select"><i class="icon-select-arrow"></i>
                                        <input type="text" class="ipt" ka="expect-position" placeholder="选择期望职位" readonly="" value="" name="positionName">
                                        <input type="hidden" name="position" class="required" value="" data-blank="请选择您的期望职位">
                                    </span>
                                    <div class="dropdown-menu">
                                        <script>
                                            var jobData = positionList;
                                ...
                                <dd>
                                    <div class="salary-item start-salary">
                                        <span class="dropdown-select"><i class="icon-select-arrow"></i>
                                            ...
                                            <input type="text" ka="expect-lowsalary" value="" class="ipt ipt-short" placeholder="选择薪资范围" readonly="">
                                            <input type="hidden" value="" name="lowSalary" class="required" data-blank="请选择期望薪资范围"></span>
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li data-val="面议">面议</li>
                                                
                                                    <li ka="lowsalary-1" data-val="1">1K</li>
                                                
                                                    <li ka="lowsalary-2" data-val="2">2K</li>
                                                
                                                    <li ka="lowsalary-3" data-val="3">3K</li>
                                                
                                                    <li ka="lowsalary-4" data-val="4">4K</li>
                                                
                                                    <li ka="lowsalary-5" data-val="5">5K</li>
                                                
                                                    <li ka="lowsalary-6" data-val="6">6K</li>
                                                
                                                    <li ka="lowsalary-7" data-val="7">7K</li>
                                                
                                                    <li ka="lowsalary-8" data-val="8">8K</li>
                                                
                                                    <li ka="lowsalary-9" data-val="9">9K</li>
                                                
                                                    <li ka="lowsalary-10" data-val="10">10K</li>
                                                
                                                    <li ka="lowsalary-11" data-val="11">11K</li>
                                                
                                                    <li ka="lowsalary-12" data-val="12">12K</li>
                                                
                                                    <li ka="lowsalary-13" data-val="13">13K</li>
                                                
                                                    <li ka="lowsalary-14" data-val="14">14K</li>
                                                
                                                    <li ka="lowsalary-15" data-val="15">15K</li>
                                                
                                                    <li ka="lowsalary-16" data-val="16">16K</li>
                                                
                                                    <li ka="lowsalary-17" data-val="17">17K</li>
                                                
                                                    <li ka="lowsalary-18" data-val="18">18K</li>
                                                
                                                    <li ka="lowsalary-19" data-val="19">19K</li>
                                                
                                                    <li ka="lowsalary-20" data-val="20">20K</li>
                                                
                                                    <li ka="lowsalary-21" data-val="21">21K</li>
                                                
                                                    <li ka="lowsalary-22" data-val="22">22K</li>
                                                
                                                    <li ka="lowsalary-23" data-val="23">23K</li>
                                                
                                                    <li ka="lowsalary-24" data-val="24">24K</li>
                                                
                                                    <li ka="lowsalary-25" data-val="25">25K</li>
                                                
                                                    <li ka="lowsalary-26" data-val="26">26K</li>
                                                
                                                    <li ka="lowsalary-27" data-val="27">27K</li>
                                                
                                                    <li ka="lowsalary-28" data-val="28">28K</li>
                                                
                                                    <li ka="lowsalary-29" data-val="29">29K</li>
                                                
                                                    <li ka="lowsalary-30" data-val="30">30K</li>
                                                
                                                    <li ka="lowsalary-31" data-val="31">31K</li>
                                                
                                                    <li ka="lowsalary-32" data-val="32">32K</li>
                                                
                                                    <li ka="lowsalary-33" data-val="33">33K</li>
                                                
                                                    <li ka="lowsalary-34" data-val="34">34K</li>
                                                
                                                    <li ka="lowsalary-35" data-val="35">35K</li>
                                                
                                                    <li ka="lowsalary-36" data-val="36">36K</li>
                                                
                                                    <li ka="lowsalary-37" data-val="37">37K</li>
                                                
                                                    <li ka="lowsalary-38" data-val="38">38K</li>
                                                
                                                    <li ka="lowsalary-39" data-val="39">39K</li>
                                                
                                                    <li ka="lowsalary-40" data-val="40">40K</li>
                                                
                                                    <li ka="lowsalary-41" data-val="41">41K</li>
                                                
                                                    <li ka="lowsalary-42" data-val="42">42K</li>
                                                
                                                    <li ka="lowsalary-43" data-val="43">43K</li>
                                                
                                                    <li ka="lowsalary-44" data-val="44">44K</li>
                                                
                                                    <li ka="lowsalary-45" data-val="45">45K</li>
                                                
                                                    <li ka="lowsalary-46" data-val="46">46K</li>
                                                
                                                    <li ka="lowsalary-47" data-val="47">47K</li>
                                                
                                                    <li ka="lowsalary-48" data-val="48">48K</li>
                                                
                                                    <li ka="lowsalary-49" data-val="49">49K</li>
                                                
                                                    <li ka="lowsalary-50" data-val="50">50K</li>
                                                
                                                
                                                    <li ka="lowsalary-60" data-val="60">60K</li>
                                                
                                                    <li ka="lowsalary-70" data-val="70">70K</li>
                                                
                                                    <li ka="lowsalary-80" data-val="80">80K</li>
                                                
                                                    <li ka="lowsalary-90" data-val="90">90K</li>
                                                
                                                    <li ka="lowsalary-100" data-val="100">100K</li>
                                                
                                                    <li ka="lowsalary-110" data-val="110">110K</li>
                                                
                                                    <li ka="lowsalary-120" data-val="120">120K</li>
                                                
                                                    <li ka="lowsalary-130" data-val="130">130K</li>
                                                
                                                    <li ka="lowsalary-140" data-val="140">140K</li>
                                                
                                                    <li ka="lowsalary-150" data-val="150">150K</li>
                                                
                                                    <li ka="lowsalary-160" data-val="160">160K</li>
                                                
                                                    <li ka="lowsalary-170" data-val="170">170K</li>
                                                
                                                    <li ka="lowsalary-180" data-val="180">180K</li>
                                                
                                                    <li ka="lowsalary-190" data-val="190">190K</li>
                                                
                                                    <li ka="lowsalary-200" data-val="200">200K</li>
                                                
                                                    <li ka="lowsalary-210" data-val="210">210K</li>
                                                
                                                    <li ka="lowsalary-220" data-val="220">220K</li>
                                                
                                                    <li ka="lowsalary-230" data-val="230">230K</li>
                                                
                                                    <li ka="lowsalary-240" data-val="240">240K</li>
                                                
                                                    <li ka="lowsalary-250" data-val="250">250K</li>
                                                
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="salary-item end-salary">
                                        <span class="dropdown-select dropdown-disabled"><i class="icon-select-arrow"></i>
                                            <input type="text" ka="expect-highsalary" value="" class="ipt ipt-short" placeholder="选择薪资范围" readonly="" disabled="disabled">
                                            <input type="hidden" value="" name="highSalary" class="required" data-blank="请选择期望薪资范围">
                                        </span>
                                        <div class="dropdown-menu">
                                            <ul>
                                            </ul>
                            ...
                            <div class="form-row">
                                <dd>
                                    <span>
                                        <input type="text" ka="expect-industry" name="industryStr" class="ipt" value="" placeholder="选择行业" readonly="">
                                        <input type="hidden" name="industryCodes" value="0" class="required" data-blank="请选择期望行业" data-format="最多可选3个行业"></span>
                                    <div class="dropdown-menu">
                                        <div class="select-industry">
                                            <div class="industry-title">
                                                <div class="btns"><button class="btn btn-back" ka="expect-industry-cancel" type="button">取消</button><button class="btn" ka="expect-industry-ok" type="button">确定</button></div>
                                                <h3>最多可选三个行业</h3>
                                            </div>
                                            <div class="industry-cells">
                                                
                                                    <span ka="expect-industry-100001" data-val="100001">电子商务</span>
                                                
                                                    <span ka="expect-industry-100002" data-val="100002">游戏</span>
                                                
                                                    <span ka="expect-industry-100003" data-val="100003">媒体</span>
                                                
                                                    <span ka="expect-industry-100004" data-val="100004">广告营销</span>
                                                
                                                    <span ka="expect-industry-100005" data-val="100005">数据服务</span>
                                                
                                                    <span ka="expect-industry-100006" data-val="100006">医疗健康</span>
                                                
                                                    <span ka="expect-industry-100007" data-val="100007">生活服务</span>
                                                
                                                    <span ka="expect-industry-100008" data-val="100008">O2O</span>
                                                
                                                    <span ka="expect-industry-100009" data-val="100009">旅游</span>
                                                
                                                    <span ka="expect-industry-100010" data-val="100010">分类信息</span>
                                                
                                                    <span ka="expect-industry-100011" data-val="100011">音乐/视频/阅读</span>
                                                
                                                    <span ka="expect-industry-100012" data-val="100012">在线教育</span>
                                                
                                                    <span ka="expect-industry-100013" data-val="100013">社交网络</span>
                                                
                                                    <span ka="expect-industry-100014" data-val="100014">人力资源服务</span>
                                                
                                                    <span ka="expect-industry-100015" data-val="100015">企业服务</span>
                                                
                                                    <span ka="expect-industry-100016" data-val="100016">信息安全</span>
                                                
                                                    <span ka="expect-industry-100018" data-val="100018">智能硬件</span>
                                                
                                                    <span ka="expect-industry-100019" data-val="100019">移动互联网</span>
                                                
                                                    <span ka="expect-industry-100020" data-val="100020">互联网</span>
                                                
                                                    <span ka="expect-industry-100021" data-val="100021">计算机软件</span>
                                                
                                                    <span ka="expect-industry-100024" data-val="100024">通信/网络设备</span>
                                                
                                                    <span ka="expect-industry-100101" data-val="100101">广告/公关/会展</span>
                                                
                                                    <span ka="expect-industry-100206" data-val="100206">互联网金融</span>
                                                
                                                    <span ka="expect-industry-100502" data-val="100502">物流/仓储</span>
                                                
                                                    <span ka="expect-industry-100504" data-val="100504">贸易/进出口</span>
                                                
                                                    <span ka="expect-industry-100601" data-val="100601">咨询</span>
                                                
                                                    <span ka="expect-industry-100702" data-val="100702">工程施工</span>
                                                
                                                    <span ka="expect-industry-100801" data-val="100801">汽车生产</span>
                                                
                                                    <span ka="expect-industry-101304" data-val="101304">其他行业</span>
                            ...
                            <div class="form-row">
                                <dd>
                                    <input type="text" ka="expect-city" name="locationName" value="" class="ipt ipt-autocomplete required" data-url="/autocomplete/city.json" placeholder="期望城市" data-blank="请选择期望城市" autocomplete="off">
                                    <input type="hidden" name="location" value="" class="required" data-blank="请选择期望城市">
                                    <div class="suggest-complete"></div>
                                </dd>
                            </div>
                            <div class="btn-footer">
                                <a href="javascript:;" ka="expect-previous" class="prev">上一步</a>
                                <button type="submit" ka="expect-next" class="btn">下一步</button>
                            </div>
                        </form>
                    </div>
                </div>
                <!-- 优势 -->
                <div class="advtange-info info-box hide">
                    <div class="description">
                        <div class="top"><i class="icon icon-advtange"></i></div>
                        <div class="center">再次欢迎您来到BOSS直聘<br>这一次，试试用聊天的方式找工作</div>
                        <div class="bottom">zhipin.com</div>
                    </div>
                    <div class="form-box">
                        <h4>最后，告诉boss您的优势</h4>
                        <form action="https://www.zhipin.com/geek/saveUserDesc.json">
                            <input type="hidden" name="edit" value="complete">
                            <div class="form-row">
                                <dd>
                                    <div class="text-con">
                                        <textarea name="advantage" ka="user-desc" placeholder="您可以总结一下之前的工作成果，也可以向 boss 展示您
擅长的工作技能和方向 " class="ipt required ipt-advantage" data-range="1,140" data-blank="请填写优势" data-format="请输入 140 字以内的优势"></textarea>
                                        <span class="count-num"><em>0</em>/140</span>
                                    </div>
                                </dd>
                            </div>
                            <div class="btn-footer">
                                <a href="javascript:;" ka="user-desc-previous" class="prev">上一步</a>
                                <button type="submit" ka="user-desc-finish" class="btn">完成</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="avatar_layer guide_layer avatar_layer_html5">
        <div class="hd"><i class="close"></i></div>
        <div class="main">
            <div class="selectpic">
                <div class="sbox">
                    <a class="btns" href="https://www.zhipin.com/geek/complete/guide.html#">选择图片</a>
                    <input type="file" class="selectfile">
                    <p>只支持jpg、png、大小不超过2M</p>
                </div>
                <div class="default-avatar">
                    <p>默认头像</p>
                    <div class="avatar-con">
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_9.png" data-id="9"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_10.png" data-id="10"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_11.png" data-id="11"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_12.png" data-id="12"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_13.png" data-id="13"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_14.png" data-id="14"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_15.png" data-id="15"></div>
                        <div class="img-box"><div class="pop"></div><img src="./img/avatar_16.png" data-id="16"></div>
                    </div>
                </div>
                <div class="editbox">
                    <canvas></canvas>
                    <div class="pop"><i></i></div>
                </div>
            </div>
            <div class="layer_btns">
                <span class="change">更换图片<input type="file" class="selectfile"></span>
                <a class="sure" href="javascript:;" ka="avatar_layer_html5_button_sure">确 定</a>
            </div>
        </div>
    </div>
</div>
...
<input type="hidden" id="page_key_name" value="cpc_user_comp">
...
<div class="datetimepicker datetimepicker-dropdown-bottom-right" style="left: 518.333px; z-index: 70;"><div class="datetimepicker-minutes" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">31 十二月 2003</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="minute active">0:00</span><span class="minute disabled">0:05</span><span class="minute disabled">0:10</span><span class="minute disabled">0:15</span><span class="minute disabled">0:20</span><span class="minute disabled">0:25</span><span class="minute disabled">0:30</span><span class="minute disabled">0:35</span><span class="minute disabled">0:40</span><span class="minute disabled">0:45</span><span class="minute disabled">0:50</span><span class="minute disabled">0:55</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-hours" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">31 十二月 2003</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="hour active">0:00</span><span class="hour disabled">1:00</span><span class="hour disabled">2:00</span><span class="hour disabled">3:00</span><span class="hour disabled">4:00</span><span class="hour disabled">5:00</span><span class="hour disabled">6:00</span><span class="hour disabled">7:00</span><span class="hour disabled">8:00</span><span class="hour disabled">9:00</span><span class="hour disabled">10:00</span><span class="hour disabled">11:00</span><span class="hour disabled">12:00</span><span class="hour disabled">13:00</span><span class="hour disabled">14:00</span><span class="hour disabled">15:00</span><span class="hour disabled">16:00</span><span class="hour disabled">17:00</span><span class="hour disabled">18:00</span><span class="hour disabled">19:00</span><span class="hour disabled">20:00</span><span class="hour disabled">21:00</span><span class="hour disabled">22:00</span><span class="hour disabled">23:00</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-days" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">十二月 2003</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr><tr><th class="dow">一</th><th class="dow">二</th><th class="dow">三</th><th class="dow">四</th><th class="dow">五</th><th class="dow">六</th><th class="dow">日</th></tr></thead><tbody><tr><td class="day old"><em>24</em></td><td class="day old"><em>25</em></td><td class="day old"><em>26</em></td><td class="day old"><em>27</em></td><td class="day old"><em>28</em></td><td class="day old"><em>29</em></td><td class="day old"><em>30</em></td></tr><tr><td class="day"><em>1</em></td><td class="day"><em>2</em></td><td class="day"><em>3</em></td><td class="day"><em>4</em></td><td class="day"><em>5</em></td><td class="day"><em>6</em></td><td class="day"><em>7</em></td></tr><tr><td class="day"><em>8</em></td><td class="day"><em>9</em></td><td class="day"><em>10</em></td><td class="day"><em>11</em></td><td class="day"><em>12</em></td><td class="day"><em>13</em></td><td class="day"><em>14</em></td></tr><tr><td class="day"><em>15</em></td><td class="day"><em>16</em></td><td class="day"><em>17</em></td><td class="day"><em>18</em></td><td class="day"><em>19</em></td><td class="day"><em>20</em></td><td class="day"><em>21</em></td></tr><tr><td class="day"><em>22</em></td><td class="day"><em>23</em></td><td class="day"><em>24</em></td><td class="day"><em>25</em></td><td class="day"><em>26</em></td><td class="day"><em>27</em></td><td class="day"><em>28</em></td></tr><tr><td class="day"><em>29</em></td><td class="day"><em>30</em></td><td class="day"><em>31</em></td><td class="day new disabled"><em>1</em></td><td class="day new disabled"><em>2</em></td><td class="day new disabled"><em>3</em></td><td class="day new disabled"><em>4</em></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-months" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2003</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="month">一月</span><span class="month">二月</span><span class="month">三月</span><span class="month">四月</span><span class="month">五月</span><span class="month">六月</span><span class="month">七月</span><span class="month">八月</span><span class="month">九月</span><span class="month">十月</span><span class="month">十一月</span><span class="month">十二月</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-years" style="display: block;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2000-2009</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="year old" data-year="1999">1999</span><span class="year" data-year="2000">2000</span><span class="year" data-year="2001">2001</span><span class="year" data-year="2002">2002</span><span class="year" data-year="2003">2003</span><span class="year disabled" data-year="2004">2004</span><span class="year disabled" data-year="2005">2005</span><span class="year disabled" data-year="2006">2006</span><span class="year disabled" data-year="2007">2007</span><span class="year disabled" data-year="2008">2008</span><span class="year disabled" data-year="2009">2009</span><span class="year old disabled" data-year="2010">2010</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div></div><div class="workstartpicker-wrap"><div class="year-wrap"><div class="title"><i class="prev"></i><i class="next"></i><p class="text">2008 - 应届生</p></div><div class="content"><ul><li class="year selected" data-val="0">应届生</li><li class="year " data-val="2018">2018</li><li class="year " data-val="2017">2017</li><li class="year " data-val="2016">2016</li><li class="year " data-val="2015">2015</li><li class="year " data-val="2014">2014</li><li class="year " data-val="2013">2013</li><li class="year " data-val="2012">2012</li><li class="year " data-val="2011">2011</li><li class="year " data-val="2010">2010</li><li class="year " data-val="2009">2009</li><li class="year " data-val="2008">2008</li></ul></div></div><div class="month-wrap"></div></div><div class="datetimepicker datetimepicker-dropdown-bottom-right date-showminyear" style="left: 0px; z-index: 120;"><div class="datetimepicker-minutes" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">16 四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="minute active">0:00</span><span class="minute disabled">0:05</span><span class="minute disabled">0:10</span><span class="minute disabled">0:15</span><span class="minute disabled">0:20</span><span class="minute disabled">0:25</span><span class="minute disabled">0:30</span><span class="minute disabled">0:35</span><span class="minute disabled">0:40</span><span class="minute disabled">0:45</span><span class="minute disabled">0:50</span><span class="minute disabled">0:55</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-hours" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">16 四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="hour active">0:00</span><span class="hour disabled">1:00</span><span class="hour disabled">2:00</span><span class="hour disabled">3:00</span><span class="hour disabled">4:00</span><span class="hour disabled">5:00</span><span class="hour disabled">6:00</span><span class="hour disabled">7:00</span><span class="hour disabled">8:00</span><span class="hour disabled">9:00</span><span class="hour disabled">10:00</span><span class="hour disabled">11:00</span><span class="hour disabled">12:00</span><span class="hour disabled">13:00</span><span class="hour disabled">14:00</span><span class="hour disabled">15:00</span><span class="hour disabled">16:00</span><span class="hour disabled">17:00</span><span class="hour disabled">18:00</span><span class="hour disabled">19:00</span><span class="hour disabled">20:00</span><span class="hour disabled">21:00</span><span class="hour disabled">22:00</span><span class="hour disabled">23:00</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-days" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr><tr><th class="dow">一</th><th class="dow">二</th><th class="dow">三</th><th class="dow">四</th><th class="dow">五</th><th class="dow">六</th><th class="dow">日</th></tr></thead><tbody><tr><td class="day old"><em>26</em></td><td class="day old"><em>27</em></td><td class="day old"><em>28</em></td><td class="day old"><em>29</em></td><td class="day old"><em>30</em></td><td class="day old"><em>31</em></td><td class="day"><em>1</em></td></tr><tr><td class="day"><em>2</em></td><td class="day"><em>3</em></td><td class="day"><em>4</em></td><td class="day"><em>5</em></td><td class="day"><em>6</em></td><td class="day"><em>7</em></td><td class="day"><em>8</em></td></tr><tr><td class="day"><em>9</em></td><td class="day"><em>10</em></td><td class="day"><em>11</em></td><td class="day"><em>12</em></td><td class="day"><em>13</em></td><td class="day"><em>14</em></td><td class="day"><em>15</em></td></tr><tr><td class="day today active"><em>16</em></td><td class="day disabled"><em>17</em></td><td class="day disabled"><em>18</em></td><td class="day disabled"><em>19</em></td><td class="day disabled"><em>20</em></td><td class="day disabled"><em>21</em></td><td class="day disabled"><em>22</em></td></tr><tr><td class="day disabled"><em>23</em></td><td class="day disabled"><em>24</em></td><td class="day disabled"><em>25</em></td><td class="day disabled"><em>26</em></td><td class="day disabled"><em>27</em></td><td class="day disabled"><em>28</em></td><td class="day disabled"><em>29</em></td></tr><tr><td class="day disabled"><em>30</em></td><td class="day new disabled"><em>1</em></td><td class="day new disabled"><em>2</em></td><td class="day new disabled"><em>3</em></td><td class="day new disabled"><em>4</em></td><td class="day new disabled"><em>5</em></td><td class="day new disabled"><em>6</em></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-months" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="month">一月</span><span class="month">二月</span><span class="month">三月</span><span class="month active">四月</span><span class="month disabled">五月</span><span class="month disabled">六月</span><span class="month disabled">七月</span><span class="month disabled">八月</span><span class="month disabled">九月</span><span class="month disabled">十月</span><span class="month disabled">十一月</span><span class="month disabled">十二月</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-years" style="display: block;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2010-2019</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="year old" data-year="2009">2009</span><span class="year" data-year="2010">2010</span><span class="year" data-year="2011">2011</span><span class="year" data-year="2012">2012</span><span class="year" data-year="2013">2013</span><span class="year" data-year="2014">2014</span><span class="year" data-year="2015">2015</span><span class="year" data-year="2016">2016</span><span class="year" data-year="2017">2017</span><span class="year active" data-year="2018">2018</span><span class="year disabled" data-year="2019">2019</span><span class="year old disabled" data-year="2020">2020</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today" style="display: none;"><div class="today-btn">至今</div></th></tr></tfoot></table></div></div><div class="datetimepicker datetimepicker-dropdown-bottom-right" style="left: 0px; z-index: 170;"><div class="datetimepicker-minutes" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">16 四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="minute active">0:00</span><span class="minute disabled">0:05</span><span class="minute disabled">0:10</span><span class="minute disabled">0:15</span><span class="minute disabled">0:20</span><span class="minute disabled">0:25</span><span class="minute disabled">0:30</span><span class="minute disabled">0:35</span><span class="minute disabled">0:40</span><span class="minute disabled">0:45</span><span class="minute disabled">0:50</span><span class="minute disabled">0:55</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-hours" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">16 四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="hour active">0:00</span><span class="hour disabled">1:00</span><span class="hour disabled">2:00</span><span class="hour disabled">3:00</span><span class="hour disabled">4:00</span><span class="hour disabled">5:00</span><span class="hour disabled">6:00</span><span class="hour disabled">7:00</span><span class="hour disabled">8:00</span><span class="hour disabled">9:00</span><span class="hour disabled">10:00</span><span class="hour disabled">11:00</span><span class="hour disabled">12:00</span><span class="hour disabled">13:00</span><span class="hour disabled">14:00</span><span class="hour disabled">15:00</span><span class="hour disabled">16:00</span><span class="hour disabled">17:00</span><span class="hour disabled">18:00</span><span class="hour disabled">19:00</span><span class="hour disabled">20:00</span><span class="hour disabled">21:00</span><span class="hour disabled">22:00</span><span class="hour disabled">23:00</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-days" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">四月 2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr><tr><th class="dow">一</th><th class="dow">二</th><th class="dow">三</th><th class="dow">四</th><th class="dow">五</th><th class="dow">六</th><th class="dow">日</th></tr></thead><tbody><tr><td class="day old"><em>26</em></td><td class="day old"><em>27</em></td><td class="day old"><em>28</em></td><td class="day old"><em>29</em></td><td class="day old"><em>30</em></td><td class="day old"><em>31</em></td><td class="day"><em>1</em></td></tr><tr><td class="day"><em>2</em></td><td class="day"><em>3</em></td><td class="day"><em>4</em></td><td class="day"><em>5</em></td><td class="day"><em>6</em></td><td class="day"><em>7</em></td><td class="day"><em>8</em></td></tr><tr><td class="day"><em>9</em></td><td class="day"><em>10</em></td><td class="day"><em>11</em></td><td class="day"><em>12</em></td><td class="day"><em>13</em></td><td class="day"><em>14</em></td><td class="day"><em>15</em></td></tr><tr><td class="day today active"><em>16</em></td><td class="day disabled"><em>17</em></td><td class="day disabled"><em>18</em></td><td class="day disabled"><em>19</em></td><td class="day disabled"><em>20</em></td><td class="day disabled"><em>21</em></td><td class="day disabled"><em>22</em></td></tr><tr><td class="day disabled"><em>23</em></td><td class="day disabled"><em>24</em></td><td class="day disabled"><em>25</em></td><td class="day disabled"><em>26</em></td><td class="day disabled"><em>27</em></td><td class="day disabled"><em>28</em></td><td class="day disabled"><em>29</em></td></tr><tr><td class="day disabled"><em>30</em></td><td class="day new disabled"><em>1</em></td><td class="day new disabled"><em>2</em></td><td class="day new disabled"><em>3</em></td><td class="day new disabled"><em>4</em></td><td class="day new disabled"><em>5</em></td><td class="day new disabled"><em>6</em></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-months" style="display: none;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2018</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="month">一月</span><span class="month">二月</span><span class="month">三月</span><span class="month active">四月</span><span class="month disabled">五月</span><span class="month disabled">六月</span><span class="month disabled">七月</span><span class="month disabled">八月</span><span class="month disabled">九月</span><span class="month disabled">十月</span><span class="month disabled">十一月</span><span class="month disabled">十二月</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today"><div class="today-btn">至今</div></th></tr></tfoot></table></div><div class="datetimepicker-years" style="display: block;"><table class="table-condensed"><thead><tr><th class="prev" style="visibility: visible;"><i class="fz fz-arrow-left"></i></th><th colspan="5" class="switch">2010-2019</th><th class="next" style="visibility: hidden;"><i class="fz fz-arrow-right"></i></th></tr></thead><tbody><tr><td colspan="7"><span class="year old" data-year="2009">2009</span><span class="year" data-year="2010">2010</span><span class="year" data-year="2011">2011</span><span class="year" data-year="2012">2012</span><span class="year" data-year="2013">2013</span><span class="year" data-year="2014">2014</span><span class="year" data-year="2015">2015</span><span class="year" data-year="2016">2016</span><span class="year" data-year="2017">2017</span><span class="year active" data-year="2018">2018</span><span class="year disabled" data-year="2019">2019</span><span class="year old disabled" data-year="2020">2020</span></td></tr></tbody><tfoot class="tfoot"><tr><th colspan="7" class="today"><div class="today-btn">至今</div></th></tr></tfoot></table></div></div></body></html>