<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\employer\info.html";i:1525421667;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525685174;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="item-form"><form action="/geek/user/save.json" method="post" class="form-resume">
                        ...
                        <div class="form-row">
                            <dl>
                                ...
                                <dd><input type="text" disabled class="ipt required" placeholder=""  data-blank="" data-format="" maxlength="24" ka="et-uname" name="username" value="<?php echo isset($row['username'])?$row['username']: ''; ?>"></dd>
                            </dl>
                            <dl>
                                <dt>当前职业</dt>
                                <dd>
                            
                                    <input type="text" disabled class="ipt required" placeholder="" data-blank="" data-format="" maxlength="24" ka="et-uname" name="position" value="<?php echo isset($row['position'])?$row['position']:''; ?>">
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="form-row">
                                ...
                                <a href="/employer/addinfo"><button class="btn btn-back" type="button" ka="user-resume-user-info-cancel">添加</button></a>
                                <?php endif; if(!(empty($row) || (($row instanceof \think\Collection || $row instanceof \think\Paginator ) && $row->isEmpty()))): ?>
                                <a href="/employer/addinfo"><button class="btn vali_btn" type="button" ka="user-resume-user-info-ok">修改</button></a>
                                <?php endif; ?>
                            </div>
                        </div>
