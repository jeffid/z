<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\APP\wamp\www\XDL\zhipin\public/../application/home\view\search.html";i:1525278473;s:65:"D:\APP\wamp\www\XDL\zhipin\application\home\view\public\base.html";i:1525268995;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="search-form-con">
                        <div class="city-sel">
                            ...
                            <span class="label-text">
                                <b>深圳</b><i class="icon-arrow-down"></i>
                            </span>
                        </div>
    ...
    <div class="job-box">
        <div class="sider">
            ...
            <div class="promotion-img nomargin"><a href="javascript:;"
                                                   target="_blank" ka="ad_banner_0"><img src="./img/promotion.jpg"
                                                                                         alt=""></a></div>
            <div class="promotion-img"><a href="javascript:;" target="_blank"
                                          ka="ad_banner_1"><img src="./img/pro-1.png" alt=""></a></div>
            <div class="promotion-img"><a href="javascript:;" target="_blank"
                                          ka="ad_banner_2"><img src="./img/pro-2.png" alt=""></a></div>
        </div>
        <div class="job-list">
                ...
                <li>
                    <div class="job-primary">
                        <div class="info-primary">
                            ...
                            <p><?php echo $item['j_location']; ?><em class="vline"></em><?php echo $item['j_experience']; ?><em class="vline"></em><?php echo $item['j_degree']; ?></p>
                        </div>
                        
                        <div class="info-company">
                            <div class="company-text">
                                <h3 class="name"><a href="/companys/index/cid/<?php echo $item['co_id']; ?>" ka="search_list_company_1_custompage" target="_blank"><?php echo $item['co_name']; ?></a>
                                </h3>
                                <p><?php echo $item['co_industry']; ?><em class="vline"></em><?php echo $item['co_financing']; ?><em class="vline"></em><?php echo $item['co_employees']; ?>人</p>
                            </div>
                        </div>
                        
                        <div class="info-publis">
                            <h3 class="name"><img src="<?php echo isset($item['hr_avatar'])?$item['hr_avatar']: \think\Session::get('default.avatar'); ?>"><?php echo $item['hr_name']; ?><em class="vline"></em><?php echo $item['hr_position']; ?></h3>
...
<div id="siderbar" style="display: none;">
    <ul>
        ...
        <li class="siderbar-qrcode" title="BOSS直聘APP">
            <div class="qrcode-layer"><i></i><img src="./img/common.json" alt="">下载BOSS直聘APP</div>
        </li>
    </ul>
</div>
</div>
